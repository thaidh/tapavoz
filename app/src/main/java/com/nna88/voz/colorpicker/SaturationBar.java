...
public class SaturationBar extends View {
    ...
    private void calculateColor(int i) {
        ...
        r2[1] = ((float) i2) * this.mPosToSatFactor;
        r2[2] = PhotoViewAttacher.DEFAULT_MIN_SCALE;
        this.mColor = Color.HSVToColor(r2);
    }
...
//        obtainStyledAttributes.recycle();
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (isInEditMode()) {
            this.shader = new LinearGradient((float) this.mBarPointerHaloRadius, 0.0f, (float) (this.mBarLength + this.mBarPointerHaloRadius), (float) this.mBarThickness, new int[]{-1, -8257792}, null, TileMode.CLAMP);
        ...
        this.mBarPointerPosition = Math.round((fArr[1] * this.mSatToPosFactor) + ((float) this.mBarPointerHaloRadius));
    }
