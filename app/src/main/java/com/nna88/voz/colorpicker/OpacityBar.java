...
public class OpacityBar extends View {
    ...
    private void calculateColor(int i) {
        ...
        this.mColor = Color.HSVToColor(Math.round(((float) i2) * this.mPosToOpacFactor), this.mHSVColor);
...
//        obtainStyledAttributes.recycle();
    ...
    public int getOpacity() {
        ...
        return round < 5 ? 0 : round > 250 ? MotionEventCompat.ACTION_MASK : round;
    }
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (isInEditMode()) {
            this.shader = new LinearGradient((float) this.mBarPointerHaloRadius, 0.0f, (float) (this.mBarLength + this.mBarPointerHaloRadius), (float) this.mBarThickness, new int[]{8519424, -8257792}, null, TileMode.CLAMP);
            ...
            int HSVToColor = Color.HSVToColor(0, this.mHSVColor);
            int HSVToColor2 = Color.HSVToColor(MotionEventCompat.ACTION_MASK, this.mHSVColor);
            int[] iArr = new int[]{HSVToColor, HSVToColor2};
        ...
        if (isInEditMode()) {
            ...
            this.mBarPointerPosition = Math.round(this.mOpacToPosFactor * ((float) Color.alpha(this.mColor))) + this.mBarPointerHaloRadius;
        }
    }
